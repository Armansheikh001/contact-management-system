...
public class FrmntFireService extends Fragment {

    RecyclerView recyclerView;
    View v;
    List<Contact> listCont;
    public FrmntFireService(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = (ViewGroup) inflater.inflate(R.layout.fireservice_fragment, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.fireservice_recycleView);
